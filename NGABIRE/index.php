...
<head>
    ...
    <title>Handcrafted Home Products</title>
...
<body>
    ...
    <li>
        <h1>HANDCRFTED HOME GOODS</h1> 
        <li1><a href="signup.php">REGISTER NOW</a></li>
    ...
    <div class="menu-bar">
        ...
        <div class="bonn">
        <div class="bon1">
        <li><a href="signup.php">accout settings</a></li>
        </div>
        <div class="bon2">
        ...
        <ul class="menu-items">
            ...
            <li><marquee><h4 style="color:chartreuse;">Welcome to Handcrafted Home Products</h4></marquee></li>
            <!-- Search form added -->
            ...
            <li><a href="donates.html">donates</a></li>
...
<div class="container1">
    <div class="image-container1">
        <img src="gorilla.jpg" alt="Image" class="resized-image">
    ...
    <div class="text-container1">
        ...
        <h2>"Handcrafted Home Products"</h2>
        <p>Hero image showcasing a beautifully handcrafted product<br>
            Clear navigation menu for easy browsing of different product categories<br>
        ...
        <p1>BEST SELLING PRODUCTS</p1>
        <div class="container0">
                <div class="box1">
                    <img src="art4.jpeg">
                    <h4></h4>
                    <p>     Art with a Mission works with<br> orphans offering them an opportunity<br>
                    to discover and use <br>their artistic talent.<br>
                    <br> with orphanage centers, <br>Inema Arts Center mentors in<br>
                    art as a skill, a talent, <br>an occupation and survival skill.</p> 
                </div>
                    <div class="box2">
                    <img src="intore2.jpeg">
                    <h4></h4>
                    <p>     Art with a Mission works with<br> orphans offering them an opportunity<br>
                    to discover and use <br>their artistic talent.<br>
                    <br> with orphanage centers, <br>Inema Arts Center mentors in<br>
            ...
            <h3>BIG MISSION OF OUR COMPANY</h3>
                <p>
                    Art with a Mission works with orphans offering them an opportunity
                ...
                <div class="box">
                <img src="craft3.png" alt="Image" class="resized-image"> 
                </div>
                </div>
